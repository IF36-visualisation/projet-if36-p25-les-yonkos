...
&ensp;Pour notre projet, on a bossé avec deux datasets sur les combats de MMA dans l'UFC. Le premier, **"Complete UFC Data"**, contient plein d'infos sur les événements, les combattants et leurs stats de combat, ainsi que les cotes des paris. Ce dataset couvre une période de **1994 à 2023**, ce qui nous donne pas mal de matière pour analyser les performances et les tendances dans le MMA.
...
Nous supponsons que la majorité des rounds se terminent vers le milieu du combat : au 2ème ou 3ème round. Il y a aussi sûrement beaucoup de KO où le combat se finit vite.
...
**Interprétation :** Le graphique permet de répondre clairement à la question posée, le round 3 est celui où la majorité des combats se terminent.


##### Conclusion question 1

D’après le graphique, **le round 3 est celui où la majorité des combats se terminent**.  
...
Tout de même, les combats semblent durer au moins un certain temps avant de se conclure, ce qui peut représenter des affrontements équilibrés, des stratégies de fatigue progressive ou des combats à l’usure.
...
Nous tenons l'hypothèse que l'allonge est un facteur très important et qu'elle impact la stratégie des combatttants. Voyons comment.
...
1.  **À quel point l'allonge peut être un avantage significatif pour gagner un combat?**
    -   Les visualisations 1 et 4 offrent des perspectives claires sur cette question, en montrant la différence entre gagnants et perdants ainsi que les proportions de victoires par catégorie d'allonge. On se rend compte que plus la différence d'allonge est grande, plus elle a un impact sur la finalité du combat
...
Le seul argument qui pourrait nous empêcher de considérer la garde orthodox comme étant la meilleure garde à utiliser serait que la southpaw ou la switch possèdent un taux de victoires très élevé. 
...
**Interprétation :** Ici on peut voir qu'aucune des gardes ne garantie un taux de victoire significativement supérieur à 50%.
...
**Interpretation :** Aucune domination significatif ne peut être notée. Il semble que la garde n'est pas l'élément qui influence le plus l'issue d'un combat.

##### Conclusion question 3
Finalement on pourrait considérer la garde orhtodox comme étant la meilleure garde à utiliser. 
Bien qu'elle possède le même taux de réussite que les autres gardes, elle est tout de même beaucoup plus utiliser ce qui veut dire que numériquement, elle a permis a plus de combattants de remporter leur combats.
Une analyse plus poussée serait d'étudier les gardes utilisées selon le niveau des combattants.
...
Ici, on s'attend à ce que les combats soit plus long si les côtes sont hautes (adversaires égaux). 
...
- Sur le premier graphique, on voit que plus les cotes augmentent, plus la durée du combat semble augmenter. Ça confirme notre hypothèse de départ : si la différence de niveau est moins grande, les combats durent plus longtemps (de peu).  
